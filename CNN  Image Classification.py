# -*- coding: utf-8 -*-
"""
Created on Fri Jun 26 19:20:45 2020
...
train_datagen = ImageDataGenerator(
        rescale=1./255,#feature scaling to pixels by dividing values by 255 becoz each values will be from 0 to 255 by divid we will get from 0 to 1
        shear_range=0.2,
        zoom_range=0.2,
...
train_set = train_datagen.flow_from_directory(
        'C:\\Users\\Chandra mouli\\.spyder-py3\\Udemy\\CNN\\dataset\\training_set',
...
test_set = test_datagen.flow_from_directory(
        'C:\\Users\\Chandra mouli\\.spyder-py3\\Udemy\\CNN\\dataset\\test_set',
        target_size=(64, 64),
        batch_size=32,
        class_mode='binary')
#Building the CNN
...
test_image=image.load_img('C:\\Users\\Chandra mouli\\.spyder-py3\\Udemy\\CNN\\dataset\\single_prediction\\cat_or_dog_4.jpg',target_size=(64,64))#image in predic should be same size as the ip
